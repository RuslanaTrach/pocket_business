...
import 'package:pocket_business/main.dart';
...
class _HomeState extends State<Home> {
  ...
  void initState() {
    getMail();
    ServerManager(context).getItemsRequest((body) async {
    ...
    /* ServerManager(context).getUserRequest(email, (body) async {
                            ...
                            GestureDetector(
                              onTap: () async {
                                if (_newProductGroup.text != null &&
                                  ...
                                  try {
                                    var body =
                                        "{\"name\":\"${_newProductGroup.text}\"}";
                                    ServerManager(context).postItemsRequest(body,
                                        (body) {
                                      print(body);
